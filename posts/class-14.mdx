...
In the scene below, there are three qualitatively different objects (perhaps one is "hard" and one is "somewhat firm" and the third is "very soft"). Let us imagine that each is composed of water (imagined as cubes). 

<BabylonViewerWrapper/>

<QuestionBlock type="reading-discussion">
<Question>Since each object is made of water (cubes), and in this case the same amount of cubes, what is left to explain our different experience of these three objects?</Question>
</QuestionBlock>
