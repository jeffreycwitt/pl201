...
Work through these reading questions first, but consider the class notes that follow.
...
Parmenides claims it can't be done. If you're thing of "anything", then you are still thinking of "something". 
...
2) Second, if something comes to be from "non-being", then it comes from nothing. (But nothing, if it is really nothing, can't become something because it would first have to be something. Parmenides' view is often captured in the phrase "nothing comes from nothing".)
...
According to Paremenides, they can only be more of the "what is". Thus, the division is only an illusion. It is actually impossible to break up the line or divide it because whatever you try to use to separate or divide the line will just be more of the line itself.
...
You might consider, to where it would it move. If it tries to move to another place, what will already be there before it gets there? Won't the "What is" simply find that it was always already there.

### 4. It is necessary and eternal.

The "What is" can never have first moment in which it begins to be. Nor can it every cease to be.
...
This corollary is perhaps Parmenides' greatest and most troubling contribution to the history of philosophy.
...
And I want to call your attention to this now because this will become Plato's central inheritance from Parmenides.
