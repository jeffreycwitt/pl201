...
<Question type="reading-discussion" level={2}>Do you think it is possible to pursue your own happiness (egoism) and the happiness of a friend (altruism) at the same time? Or does one pursuit always negate the other? 
