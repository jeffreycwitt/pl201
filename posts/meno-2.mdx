...
* The passage at 97b is a key passage in this text, so I want to offer one alternative translation from G.M.A. Grube: 
...
<Question level={2}>At 97b or in the above passage, how does Socrates suggest that one "fasten" or "tie down" an opinion so that it becomes knowledge?</Question>
