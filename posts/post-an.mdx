...
<QuestionBlock type="reading-content">
  <Question level={1}>In Book II, c. 19, is Aristotle talking about deduction or induction? (Book II, c. 19 is very important chapter, so don't neglect it.)</Question>
  <Question level={2}>What are the stages from which one rises from the sensation and perception of a particular to a universal concept and/or principle?
    {/* 99b35-100a9. */}
