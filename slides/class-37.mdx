...
<HiddenBlock text="6) How does a framework that focuses on the development of virtue offer avenues that might help solve the chronic condition? (Consider Cohen pp. 329-330)"/>
